# Projeto da lanchonete pagamento Grupo 18 Pós-Tech - FIAP
...
- efetuar o pagamento de um pedido
- consultar o detalhe de um pagamento
- consultar os pagamentos realizados
...
## SonarQube
![sonar-pagamento.png](sonar-pagamento.png)
